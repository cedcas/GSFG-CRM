...
//AM Custom fields
$sugar_smarty->assign("AGENT_LICENSE", $focus->agent_license_c);
$sugar_smarty->assign("ALLIANZ_AGENT", $focus->allianz_agent_c);
$sugar_smarty->assign("AMERICAN_EQUITY_AGENT", $focus->american_equity_agent_c);
$sugar_smarty->assign("JACKSON_NATIONAL_AGENT", $focus->jackson_national_agent_c);
$sugar_smarty->assign("ING_AGENT", $focus->ing_agent_c);
$sugar_smarty->assign("OLD_MUTUAL_AGENT", $focus->old_mutual_agent_c);
$sugar_smarty->assign("AVIVA_AGENT", $focus->aviva_agent_c);
