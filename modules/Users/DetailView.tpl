...
<div id="user_detailview_tabs" class="yui-navset detailview_tabs">
    ...
    <div class="yui-content">
        <div>
            ...
            <div id='product_account'>
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="detail view">
					<tr>
					<th colspan='4' align="left" width="100%" valign="top"><h4><slot>{$MOD.LBL_PRODUCT_ACCOUNT}</slot></h4></th>
					</tr><tr>
					<td width="15%" valign="top" scope="row"><slot>{$MOD.LBL_AGENT_LICENSE}:</slot></td>
					<td width="35%" valign="top"><slot>{$AGENT_LICENSE}&nbsp;</slot></td>
					<td valign="top" scope="row"><slot>{$MOD.LBL_ALLIANZ_AGENT}&nbsp;</slot></td>
					<td valign="top"><slot>{$ALLIANZ_AGENT}&nbsp;</slot></td>
					</tr><tr>
					<td width="15%" valign="top" scope="row"><slot>{$MOD.LBL_AMERICAN_EQUITY_AGENT}:</slot></td>
					<td width="35%" valign="top"><slot>{$AMERICAN_EQUITY_AGENT}&nbsp;</slot></td>
					<td width="15%" valign="top" scope="row"><slot>{$MOD.LBL_JACKSON_NATIONAL_AGENT}:</slot></td>
					<td width="35%" valign="top"><slot>{$JACKSON_NATIONAL_AGENT}&nbsp;</slot></td>
					</tr><tr>
					<td valign="top" scope="row"><slot>{$MOD.LBL_ING_AGENT}:</slot></td>
					<td valign="top"><slot>{$ING_AGENT}&nbsp;</slot></td>
					<td valign="top" scope="row"><slot>{$MOD.LBL_OLD_MUTUAL_AGENT}:</slot></td>
					<td valign="top"><slot>{$OLD_MUTUAL_AGENT}&nbsp;</slot></td>
					</tr><tr>
					<td valign="top" scope="row"><slot>{$MOD.LBL_AVIVA_AGENT}:</slot></td>
					<td valign="top"><slot>{$AVIVA_AGENT}&nbsp;</slot></td>
					<td valign="top" scope="row"><slot>&nbsp;</slot></td>
					<td valign="top"><slot>&nbsp;</slot></td>
					</tr>
					</table>
