 ...
 * PLACE ANY CUSTOMIZATIONS IN GSF_Venues
 */

require_once('include/SugarObjects/templates/company/Company.php');

class GSF_Venues_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'GSF_Venues';
	var $object_name = 'GSF_Venues';
	var $table_name = 'gsf_venues';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $email_addresses;
		var $venue_logo_filename;
		var $venue_logo;
		function GSF_Venues_sugar(){	
		parent::Company();
	}
