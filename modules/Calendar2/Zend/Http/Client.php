 ...
 * @see Zend_Uri
 */
require_once 'modules/Calendar2/Zend/Uri.php';
 ...
 */
require_once 'modules/Calendar2/Zend/Http/Response.php';

/**
 * @see Zend_Http_Response_Stream
 */
require_once 'modules/Calendar2/Zend/Http/Response/Stream.php';
