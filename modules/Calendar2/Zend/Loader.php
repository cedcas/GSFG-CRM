...
class Zend_Loader
{
    ...
    public static function loadClass($class, $dirs = null)
    {
        ...
        if ((null !== $dirs) && !is_string($dirs) && !is_array($dirs)) {
            require_once 'modules/Calendar2/Zend/Exception.php';
        ...
        if (!empty($dirs)) {
            ...
            self::_securityCheck('modules/Calendar2/'.$file);
            //include $file;
            include 'modules/Calendar2/'.$file;
        }
    ...
    public static function autoload($class)
    {
        ...
        try {
            @self::loadClass($class, 'modules/Calendar2/');
            return $class;
        } catch (Exception $e) {
            return false;
        }
    ...
    {
        trigger_error(__CLASS__ . '::' . __METHOD__ . ' is deprecated as of 1.8.0 and will be removed with 2.0.0; use Zend_Loader_Autoloader instead', E_USER_NOTICE);
        require_once 'modules/Calendar2/Zend/Loader/Autoloader.php';
