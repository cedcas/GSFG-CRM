...
<div class='participants'>
	...
	<div style='float: left; width: 250px; text-align: center;'>
		...
		if (isPro()) {
			...
			echo "</div>";
			echo "<div class='padded'>";
			echo "<button class='button' onClick='fill_users();'>".$res_lang['LBL_DISPLAY_BUTTON']."</button>";
			echo "</div>";
		}
		?>
	...
	<div style='float: left; width: 150px; text-align: center; vertical-align: middle;'>
		<br>
		<div class='padded'>
			<button class='button' onClick='add_users();'><?php echo $res_lang['LBL_ADD_BUTTON']; ?></button>
		</div>
		<div class='padded'>
			<button class='button' id='btn_remove_users' onClick='remove_users();'><?php echo $res_lang['LBL_REMOVE_BUTTON']; ?></button>
		</div>
	</div>
	...
	<div style='float: left; width: 200px; text-align: center;'>
		<br>
		<div class='padded'>
			<select id='sel_user_list_selected' multiple size=4>
	...
	<div style='float: left; width: 150px; text-align: center; vertical-align: middle;'>
		<br>
		<div class='padded'>
			<button class='button' onClick='add_resources();'><?php echo $res_lang['LBL_ADD_BUTTON']; ?></button>
		</div>
		<div class='padded'>
