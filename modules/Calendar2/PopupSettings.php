...
?>
			...
			<table class='edit view'>
				<tr>
					<td>
						<?php echo $current_module_strings['LBL_DEFAULT_ACTIVITY']; ?>
					</td>
					<td>
						<input type='radio' name='default_activity' value='call' <?php if($default_activity == 'call') echo "checked"; ?> > <?php echo $current_module_strings['LBL_CALL']; ?>
						<br>
						<input type='radio' name='default_activity' value='meeting' <?php if($default_activity == 'meeting') echo "checked"; ?> > <?php echo $current_module_strings['LBL_MEETING']; ?>
					</td>
				</tr>
				<tr>
					<td>
						<?php echo $current_module_strings['LBL_ACTIVITY_DISPLAY']; ?>
					</td>
					<td>
						<input type='radio' name='show_activity' value='call' <?php if($show_activity == 'call') echo "checked"; ?> > <?php echo $current_module_strings['LBL_CALL_SHOW']; ?>
						<br>
						<input type='radio' name='show_activity' value='meeting' <?php if($show_activity == 'meeting') echo "checked"; ?> > <?php echo $current_module_strings['LBL_MEETING_SHOW']; ?>
						<br>
						<input type='radio' name='show_activity' value='both' <?php if($show_activity == 'both') echo "checked"; ?> > <?php echo $current_module_strings['LBL_BOTH_SHOW']; ?>
