...
<img id="more_img_EditView_team_name" absmiddle="" alt="Hide/Show" src="<?php echo SugarThemeRegistry::current()->getImageURL("advanced_search.gif"); ?>" height="8" width="8" border="0">
...
&nbsp;
<img id="remove_team_name_collection_0" name="remove_team_name_collection_0" src="<?php echo SugarThemeRegistry::current()->getImageURL("delete_inline.gif"); ?>" onclick="collection['EditView_team_name'].remove(0);">
</td>
