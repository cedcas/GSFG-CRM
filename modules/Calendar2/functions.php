...
function getStatusInHtml($status) {
	global $app_list_strings;
	switch ($status) {
	    case "accept":
	        return SugarThemeRegistry::current()->getImage("accept_inline","title=\"".$app_list_strings['dom_meeting_accept_status']['accept']."\" border=\"0\" vspace=\"0\"", "10", "12");
	        break;
	    case "decline":
	        return SugarThemeRegistry::current()->getImage("decline_inline","title=\"".$app_list_strings['dom_meeting_accept_status']['decline']."\"  border=\"0\" vspace=\"0\"");
	        break;
	    case "tentative":
	        return SugarThemeRegistry::current()->getImage("tentative_inline","title=\"".$app_list_strings['dom_meeting_accept_status']['tentative']."\" border=\"0\" vspace=\"0\"", "10", "12");
	        break;
	    default:
	        return "<img src='modules/Calendar2/images/qmark.png' title=\"".$app_list_strings['dom_meeting_accept_status']['none']."\">";
	        break;
	}
}
