...
$vardefs = array (
  ...
  array (
    ...
    array (
      ...
      'vname' => 'LBL_SEMINAR_MAILING_DATE',
      'type' => 'date',
      'massupdate' => 0,
      'comments' => '',
      'help' => '',
    ...
    array (
      ...
      'vname' => 'LBL_SEMINAR_NUMBER_OF_MAILERS',
      'type' => 'varchar',
      'massupdate' => 0,
      'comments' => '',
      'help' => '',
    ...
    array (
      ...
      'vname' => 'LBL_SEMINAR_TOTAL_CAPACITY',
      'type' => 'varchar',
      'massupdate' => 0,
      'comments' => '',
      'help' => '',
    ...
    array (
      ...
      'vname' => 'LBL_SEMINAR_ZIPCODES_FOR_MAILERS',
      'type' => 'text',
      'massupdate' => 0,
      'comments' => '',
      'help' => '',
    ...
    array (
      ...
      'vname' => 'LBL_SEMINAR_DOLLAR_SPENT',
      'type' => 'currency',
      'massupdate' => 0,
      'comments' => '',
      'help' => '',
