...
class SugarFieldCustomAddress extends SugarFieldBase {
    ...
    function getDetailViewSmarty($parentFieldArray, $vardef, $displayParams, $tabindex) {
        ...
        if(isset($current_language) && file_exists('custom/include/SugarFields/Fields/CustomAddress/' . $current_language . '.DetailView.tpl')) {
          return $this->fetch('custom/include/SugarFields/Fields/CustomAddress/' . $current_language . '.DetailView.tpl'); 	
        } else {
          return $this->fetch('custom/include/SugarFields/Fields/CustomAddress/DetailView.tpl');
        } //if-else
    }
    ...
    function getEditViewSmarty($parentFieldArray, $vardef, $displayParams, $tabindex) {
        ...
        global $current_language;
        if(isset($current_language) && file_exists('custom/include/SugarFields/Fields/CustomAddress/' . $current_language . '.EditView.tpl')) {
          return $this->fetch('custom/include/SugarFields/Fields/CustomAddress/' . $current_language . '.EditView.tpl'); 	
        } else {
          return $this->fetch('custom/include/SugarFields/Fields/CustomAddress/EditView.tpl');
        } //if-else
